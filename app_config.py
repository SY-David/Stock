...
SNAPSHOT_PRICE_DAYS = int(os.getenv("SNAPSHOT_PRICE_DAYS", "180"))
...
ALLOW_INSECURE_TWSE_SSL_FALLBACK = _parse_bool(
    os.getenv("ALLOW_INSECURE_TWSE_SSL_FALLBACK"), default=True
)
